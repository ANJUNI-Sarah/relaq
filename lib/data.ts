...
export async function fetchHomeData(): Promise<Homepage_list_response> {
    const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_API_URL}${PATHS.HOMEPAGE_LIST}`,
        {
...
export async function fetchShopList(
    ...
    const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_API_URL}${PATHS.SHOP_LIST_CREATE}`,
        {
...
// 取得商店列表
export async function fetchShopListClient(
    params: Shop_list_create_request
): Promise<Shop_list_create_response_data> {
    const response = await fetch(
        `${process.env.NEXT_PUBLIC_CLIENT_API_URL}${PATHS.SHOP_LIST_CREATE}`,
        {
            method: API_METHODS.SHOP_LIST_CREATE,
            headers: {
                "Content-Type": "application/json",
...
export async function fetchShopData(
    ...
    const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_API_URL}${PATHS.SHOP_CREATE}`,
        {
...
export async function fetchArticleList(
    ...
    const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_API_URL}${PATHS.ARTICLE_LIST_CREATE}`,
        {
...
export async function fetchArticleData(
    ...
    const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_API_URL}${PATHS.ARTICLE_CREATE}`,
        {
